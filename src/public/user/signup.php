...
<body class="bg-indigo-200 w-full h-screen flex justify-center items-center">
    <div class="w-96  bg-white pt-10 pb-10 rounded-xl">
        ...
        <form action="./signup_complete.php" method="POST">
            <p>
            <input class="border-2 border-gray-300 mb-5 w-full" placeholder="User name" type=“text” name="name" required value="<?php if (
                isset($_SESSION['userName'])
            ) {
                echo $_SESSION['userName'];
            } ?>">
            </p>
            <p><input  class="border-2 border-gray-300 mb-5 w-full" placeholder="Email" type=“mail” name="email" required value="<?php if (
