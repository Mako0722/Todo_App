...
use App\Infrastructure\Dao\tasksDao;
...
// $tasks = $post_list->OrderSearchList($tasks, $status, $searchWord, $direction, $category_id);
		...
		<nav class="bg-white shadow-lg">
			<div class="md:flex items-center justify-between py-2 px-8 md:px-12">
				...
				<div class="flex flex-col md:flex-row hidden md:block -mx-2">
					...
					<a href="/category/index.php" class="text-gray-800 rounded hover:bg-gray-900 hover:text-gray-100 hover:font-medium py-2 px-2 md:mx-2">カテゴリ一覧</a>
...
<body>
  ...
  <div class="container px-5 mx-auto text-blue-600 mb-2">
    <a href="task/article_list.php">タスクを追加</a><br>
  </div>
        ...
        <?php foreach ($tasks as $task): ?>
          <tbody>
            <tr>
              ...
              <td class="border px-4 py-2"><?php echo $task['category_name']; ?></td>
